  ...
  })(
    {
      1: [
        function (e, t, n) {
          ...
          function r(e, t) {
            (t = t || {}),
              (t.debug || m.debug) && console.log("[sw-toolbox] " + e);
          }
          function o(e) {
            var t;
            return (
        ...
        function (e, t, n) {
          ...
          function r(e) {
            return new Promise(function (t, n) {
              ...
              (r.onupgradeneeded = function () {
                r.result
                  .createObjectStore(h, { keyPath: p })
                  .createIndex(l, l, { unique: !1 });
              }),
          ...
          function i(e, t, n) {
            return new Promise(function (r, o) {
              ...
              i.objectStore(h).put({ url: t, timestamp: n }),
            ...
            return (
              ...
              i.openCache(n).then(function (t) {
                return t.match(e, c).then(function (t) {
                  var o = Date.now();
                  return i.isResponseFresh(t, r.maxAgeSeconds, o)
                    ? t
                    : i.fetchAndCache(e, n);
                });
              })
      ...
      15: [
        function (e, t, n) {
          ...
          function m(e, t, n) {
            v(t) || ((n = t || n), (t = [])), (n = n || {});
            for (
              var r = n.strict, o = !1 !== n.end, i = "", c = 0;
              c < e.length;
              c++
            ) {
              var s = e[c];
